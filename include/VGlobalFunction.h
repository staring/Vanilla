...
#define VANILLA_U2W(VanillaPort_lpu) ((_VanillaPort_lpu = (VanillaPort_lpu),_VanillaPort_lpu_=(char*)(_VanillaPort_lpu.c_str()),_VanillaPort_lpu_len = strlen(_VanillaPort_lpu_),_VanillaPort_lpw_len = VanillaUTF8ToUTF16(NULL, NULL, _VanillaPort_lpu_, _VanillaPort_lpu_len) + 1,_VanillaPort_lpw_ = (wchar_t*)malloc(_VanillaPort_lpw_len * 2),VanillaUTF8ToUTF16(_VanillaPort_lpw_, _VanillaPort_lpw_len, _VanillaPort_lpu_, _VanillaPort_lpu_len),_VanillaPort_lpw=_VanillaPort_lpw_,free(_VanillaPort_lpw_),_VanillaPort_lpw))
#define VANILLA_W2U(VanillaPort_lpw) ((_VanillaPort_lpw = (VanillaPort_lpw),_VanillaPort_lpw_=(wchar_t*)(_VanillaPort_lpw.c_str()),_VanillaPort_lpw_len = wcslen(_VanillaPort_lpw_),_VanillaPort_lpu_len = VanillaUTF16ToUTF8(NULL, NULL, _VanillaPort_lpw_, _VanillaPort_lpw_len) + 1,_VanillaPort_lpu_ = (char*)malloc(_VanillaPort_lpu_len),VanillaUTF16ToUTF8(_VanillaPort_lpu_, _VanillaPort_lpu_len, _VanillaPort_lpw_, _VanillaPort_lpw_len),_VanillaPort_lpu=_VanillaPort_lpu_,free(_VanillaPort_lpu_),_VanillaPort_lpu))
