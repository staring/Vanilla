#define VanillaPort_ICONV string _VanillaPort_lpu;char* _VanillaPort_lpu_;int _VanillaPort_lpu_len;wstring _VanillaPort_lpw;wchar_t* _VanillaPort_lpw_;int _VanillaPort_lpw_len;
